...
export const PLANS: Plan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "1,000 voice minutes / month (≈333 calls at 3 min average)",
  ...
  },
  {
    ...
    annualTotal: "$12,588",
    period: "/ month",
    description: "All locations, one platform — $210/location vs. $249 buying Pro plans individually.",
    features: [
      "Everything in Growth",
      "Up to 5 practice locations",
      "1,000 voice minutes per location (5,000 total)",
